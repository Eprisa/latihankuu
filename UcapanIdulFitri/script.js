...
Iya.addEventListener("click", function () {
    ...
    if (Iya.value == 1) {
        ...
        Text.innerHTML = "Saya Yota dan Keluarga";
        Text.classList.add('text-animate');
    }else if (Iya.value == 2) {
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
        Text.innerHTML = "Memohon maaf jika ada salah <br> yang disengaja maupun tidak disengaja";
        ...
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
        Text.innerHTML = "تَقَبَّلَ اللَّهُ مِنَّا وَمِنْكُمْ وَ تَقَبَّلْ ياَ كَرِيْمُ <br> Taqabbalallahu Minna Wa Minkum <br> Wa Taqabbal Yaa Kariimu";
        Text.classList.add('text-animate');
    }else if (Iya.value == 8) {
